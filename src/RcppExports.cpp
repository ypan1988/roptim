...
// example2_travelling_salesman
void example2_travelling_salesman();
RcppExport SEXP _roptim_example2_travelling_salesman() {
  BEGIN_RCPP
  Rcpp::RNGScope rcpp_rngScope_gen;
  example2_travelling_salesman();
  return R_NilValue;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_roptim_example1_rosen_other_methods",
     (DL_FUNC)&_roptim_example1_rosen_other_methods, 0},
    {"_roptim_example1_rosen_grad_hess_check",
     (DL_FUNC)&_roptim_example1_rosen_grad_hess_check, 0},
    {"_roptim_example1_rosen_nograd_bfgs",
     (DL_FUNC)&_roptim_example1_rosen_nograd_bfgs, 0},
    {"_roptim_example2_travelling_salesman",
     (DL_FUNC)&_roptim_example2_travelling_salesman, 0},
    {"_roptim_example3_flb_25_dims_box_con",
     (DL_FUNC)&_roptim_example3_flb_25_dims_box_con, 0},
